...
use rattle_items_match::{
    ...
    MachineBuilder as Ma, OrOperandsBuilder as Nds, OrOperator as Or, RangeIncludesMax, Repeat,
};
...
fn main() {
    ...
    let ex1 = Expected::default() // "(wschar)   1"
        ...
        .push(&Co::Once(Or::One(Cnd::Pin(' '))))
        .push(&Co::Once(Or::One(Cnd::Pin(' '))))
        .push(&Co::Once(Or::One(Cnd::Pin(' '))))
        .push(&Co::Once(Or::One(Cnd::Pin('1'))))
        .build();
    ...
    let ex5 = Expected::default() // "(wschar){1,}"
        ...
        .push(&Co::Once(Or::One(Cnd::RangeIncludesMax(digit))))
        .build();
